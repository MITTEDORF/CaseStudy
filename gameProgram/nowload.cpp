...
void CNLoad::InitObject( LPDIRECT3DDEVICE9 device )
{
	...
	m_load_icon = CLIcon::Create( device , "./data/TEXTURE/player/default/player_wait.png" , CLIcon::POINT_CENTER , D3DXVECTOR2( SCREEN_WIDTH-( CLIcon::POLYGON_SIZE * 0.5f ) , SCREEN_HEIGHT-( CLIcon::POLYGON_SIZE * 0.5f ) ) );
}